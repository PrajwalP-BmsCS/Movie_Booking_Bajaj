...
public class BookingSummary {
    ...
    public BookingSummary(int id, String title, String director, String description, String genre, LocalDate date, String location, int bookedTickets, int totalPrice) {
        this.id = id;
        this.title = title;
